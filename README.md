...
We'll begin with the distinction between income and taxable income. The federal [standard deduction](https://www.nerdwallet.com/article/taxes/standard-deduction) for income tax in 2022 is $12,950 for single filers and twice that ($25,900) for married people filing jointly. Let's say we're a single filer who earns $63,250 in 2022 from our job. We'll donate at least $300 to charity in 2022, so [we can deduct](https://www.irs.gov/about-irs/the-irs-encourages-taxpayers-to-consider-charitable-contributions) $300 from our taxable income, even though we're taking the standard deduction.<sup id="fn1">[[1]](#f1)</sup> Subtracting $300 from our gross income of $63,250 gives us an [adjusted gross income (AGI)](https://www.nerdwallet.com/article/taxes/adjusted-gross-income-agi) of $62,950. Unless we donate a great deal to charity or pay a lot of tax-deductible interest, for example, taking the standard deduction is preferable to itemizing deductions. Most people take the standard deduction, because it's preferable to itemizing deductions unless you donate a great deal to charity or pay a lot of tax-deductible interest. So we subtract $12,950 from our AGI, leaving us with a taxable income of $50,000. This is the amount that will be subject to income tax.
...
These income restrictions imply that for people with employer-sponsored retirement plans and high enough income single filers > $78K and joint filers > $129K, a Roth IRA or backdoor Roth IRA is always superior to a traditional IRA (assuming they have a employer-sponsored retirement plan). However, this doesn't mean they _should_ use a Roth IRA, because many such people would benefit more from contributing to their traditional 401(k) and HSA, thereby reducing taxes in the current year.

As you might expect, 401(k) contributions are allowed only in the current year: contributions for tax year 2022 cannot be made after Dec 31 2022, and they generally need to be made through payroll deduction. However, IRA contributions can be delayed until tax day of the following year (roughly April 15), which allows you to assess the tax consequences of traditional IRA contribution or whether you are eligible for direct Roth IRA contribution. If there is any uncertainty about whether you might exceed Roth IRA contribution limits, _do not contribute_ to your Roth IRA until the year is over and you can be certain. When you contribute to your IRA, your broker will ask you to characterize the contribution: you will mark it as (a) for the current year, (b) for the previous year, or (c) from a rollover, most commonly from a 401(k).

There are no income restrictions on contributing to 401(k) accounts or HSAs. Despite all the features I’ve [celebrated](https://github.com/investindex/Guidelines#health-savings-accounts) about HSAs, there is some potentially [bad news](https://impersonalfinances.com/california-and-new-jersey-tax-hsas/). HSA contributions are tax-deductible with regard to federal income tax, FICA taxes, and state taxes in most _but not all_ states. There are two holdouts: California and New Jersey. In these two states, HSA contributions receive no state tax breaks. It gets even worse: these states tax HSA _earnings_! Despite HSAs being a tax-advantaged account according to the federal government, CA and NJ do not agree and will tax you like you’re investing in a taxable account. If you plan to live in either of these states for a long time, the arguments I’ve made about HSA investing are far weaker. New Hampshire and Tennessee have some far milder taxes, which don't amount to a major drawback of HSAs in these states. New Hampshire [taxes](https://www.revenue.nh.gov/faq/interest-dividend.htm#who) interest and dividends that exceed $2,400 for single filers and $4,800 for joint filers. Tennessee taxes interest and dividends that exceed $1,400 for single filers and $2,500 for joint filers. Surprisingly, interest and dividends in your HSA are included. However, since these states don't tax capital gains, this will not have a large effect on your returns unless you have a very large portfolio. For many people, it does not require any state tax reporting. Feel free to write to representatives in these states, espeically CA and NJ, encouraging them to repent.
