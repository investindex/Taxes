...
The information below is general and tax law is very particular. For example, somewhat different rules apply to you if you derive most of your income from farming or fishing. People with permanent disabilities receive very different tax treatment. Understanding your own situation is important.
...
FICA taxes, also known as payroll taxes, are an important federal tax in addition to income tax. 6.2% of your paycheck funds Social Security, and an additional 1.45% funds Medicare. These add to 7.65% of all your earned income (unless your income is high). The Social Security tax stops after $147,000 of individual earnings in 2022. But the Medicare tax has no income cap and actually escalates by 0.9% at a higher income ($200K for single filers, $250K for joint filers). Continuing our example from above: the deductions for income tax do not apply to FICA tax, so we need to pay 7.65% on the full earned income of $63,250 (instead of $50,000). This works out to $4,838.62 in FICA taxes, which were likely withheld from our paycheck throughout the year. FICA taxes do not apply to capital gains or distributions, so we don't pay any more federal tax on our capital gains (including the short-term gain). That's a total of $12,345 in federal taxes.
...
So for federal income tax, there is a marriage penalty to high earners with fairly balanced incomes, but not to high-earning married couples with very imbalanced incomes. The marriage penalty for high earners is even more obvious in thresholds for [long-term capital gains](https://www.nerdwallet.com/article/taxes/capital-gains-tax-rates), the net investment income tax, the additional Medicare tax, the phasing out of deductions for traditional IRA contributions, and the phasing out of eligibility for direct Roth IRA contributions. All of these thresholds are mentioned above.
