...
As you might expect, 401(k) contributions can apply only to the current year: contributions for tax year 2022 cannot be made after Dec 31 2022, and they generally need to be made through payroll deduction. HSA contributions do not _need_ to be made through payroll deduction but it would be foolish not to do so, because contributing the money yourself would cause you to owe FICA tax on that income. In contrast to 401(k) contributions, IRA and HSA contributions can be delayed until tax day of the following year (roughly April 15). This allows you to assess the tax consequences of traditional IRA contribution or whether you are eligible for direct Roth IRA contribution. If there is any uncertainty about whether your MAGI might make you ineligible for Roth IRA contributions or tax-deductible traditional IRA contributions, _do not contribute_ to your IRA until the year is over and you can be certain. When you contribute to an IRA, your broker will ask you to characterize the contribution: you will mark it as (a) for the current year, (b) for the previous year, or (c) from a rollover, most commonly from a 401(k).
