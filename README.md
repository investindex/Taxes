...
The plot below shows the marginal tax rates for single filers in 2022 (i.e., for taxes that you will file in 2023). As you can see, most investors are taxed at a marginal rate of 15% for long-term capital gains but a higher rate for ordinary income. Married people filing jointly have thresholds that are exactly double those of single filers at the low end. However, regardless of whether married people file jointly or separately, the thresholds at the high end are less advantageous — they're pushed into the 20% marginal rate more easily. You can see all rates for ordinary income and capital gains [here](https://www.nerdwallet.com/article/taxes/capital-gains-tax-rates) and [here](https://www.nerdwallet.com/article/taxes/federal-income-tax-brackets).
