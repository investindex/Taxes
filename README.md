...
A pervasive recommendation in this guide is Vanguard's total world stock ETF, [VT](https://investor.vanguard.com/investment-products/etfs/profile/vt). Its simplicity is appealing, but policy around the [foreign tax credit](https://www.thebalance.com/foreign-tax-credit-3193475) leads to a minor caveat. When you invest in funds with international exposure like VT, some tax is withheld from dividends paid by the fund. The foreign tax credit means that you can often reduce your tax owed to the IRS if tax was withheld by a foreign country. However, the US tax code [states](https://www.law.cornell.edu/uscode/text/26/853) that in order to be eligible for the foreign tax credit, foreign assets must constitute more than 50% of the fund's value at the end of the tax year. Since VT's portfolio is more than 50% US stocks, the foreign tax credit does not apply; the withheld taxes are simply lost. So for someone willing to add a little complexity to their portfolio for a slightly better tax outcome, VT can be split into a total US component ([VTI](https://investor.vanguard.com/investment-products/etfs/profile/vti), [ITOT](https://www.ishares.com/us/products/239724/ishares-core-sp-total-us-stock-market-etf), [SCHB](https://www.schwabassetmanagement.com/products/schb)) and a total international component ([VXUS](https://investor.vanguard.com/investment-products/etfs/profile/vxus), [IXUS](https://www.ishares.com/us/products/244048/ishares-core-msci-total-international-stock-etf)). This is true only in taxable accounts. In tax-advantaged accounts, you cannot be reimbursed with a US tax credit even though the foreign tax is still withheld, so VT is ideal.
...
This pattern does not hold true if income is very high. Imagine a couple whose incomes add to $800K. If Spouse A makes $100K and Spouse B makes $700K, then they benefit from being married because Spouse B would pay 37% tax on more income as a single filer than the couple does as joint filers. However, if both spouses make $400K, their marginal rate as single filers would be 35%. Because they file jointly, their marginal rate is 37% instead. (It's possible for married people to file separately — which is distinct from the single filing status — but this is nearly always worse than filing jointly.)
