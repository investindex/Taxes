...
As you might expect, 401(k) contributions can apply only to the current year: contributions for tax year 2022 cannot be made after Dec 31 2022, and they generally need to be made through payroll deduction. However, IRA contributions can be delayed until tax day of the following year (roughly April 15), which allows you to assess the tax consequences of traditional IRA contribution or whether you are eligible for direct Roth IRA contribution. If there is any uncertainty about whether you might exceed Roth IRA contribution limits, _do not contribute_ to your Roth IRA until the year is over and you can be certain. When you contribute to your IRA, your broker will ask you to characterize the contribution: you will mark it as (a) for the current year, (b) for the previous year, or (c) from a rollover, most commonly from a 401(k).

#### HSAs

There are no income restrictions on contributing to 401(k) accounts or HSAs. Despite all the features I’ve [celebrated](https://github.com/investindex/Guidelines#health-savings-accounts) about HSAs, there is some potentially [bad news](https://impersonalfinances.com/california-and-new-jersey-tax-hsas/). HSA contributions are tax-deductible with regard to federal income tax, FICA taxes, and state taxes in most _but not all_ states. There are two holdouts: California and New Jersey. In these two states, HSA contributions and earnings receive no state tax breaks. Despite the federal government designating HSAs as tax-advantaged accounts nearly 20 years ago, CA and NJ do not agree and will tax you like you’re investing in a taxable account. If you plan to live in either of these states for a long time, the arguments I’ve made about HSA investing are far weaker. Separately, New Hampshire has a mild tax which doesn't amount to a major drawback of HSAs in that state. NH [taxes](https://www.revenue.nh.gov/faq/interest-dividend.htm#who) interest and dividends that exceed $2,400 for single filers and $4,800 for joint filers. Surprisingly, interest and dividends in your HSA are included. However, since NH doesn't tax capital gains, the effect of this tax on your returns will be negligible unless you have a very large portfolio. For people with taxable portfolios smaller than $200K, this is likely to trigger zero tax. Tennessee had a similar tax until [very recently](https://www.beacontn.org/hall-tax-finally-gone-forever). Feel free to write to representatives in these three states, espeically CA and NJ, encouraging them to repent.
