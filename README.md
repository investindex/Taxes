...
We introduced the basics of tax-advantaged accounts in [a previous section](https://github.com/investindex/Guidelines#tax-advantaged-accounts). We'll cover some additional details here, starting with IRAs. Ensure that you've read the material above before starting this section: you need to know the terms adjusted gross income (AGI) and modified adjusted gross income (MAGI).
...
I recommend [this Bogleheads post](https://www.bogleheads.org/wiki/Tax-efficient_fund_placement) on tax-efficient fund placement. In the near future I'll expand this section.
