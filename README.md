...
Those with high incomes may be affected by the [net investment income tax](https://www.investopedia.com/terms/n/netinvestmentincome.asp), which adds a 3.8% tax to capital gains if your [modified adjusted gross income (MAGI)](https://www.investopedia.com/terms/m/magi.asp) exceeds a certain threshold. MAGI is calculated by starting with AGI and adding back some deductions, so gross income ≥ MAGI ≥ AGI. If MAGI exceeds $200K for single filers and $250K for joint filers, this tax is [applied](https://www.irs.gov/newsroom/questions-and-answers-on-the-net-investment-income-tax) to net investment income above the threshold. Here are a couple examples: a single filer with $180K of earned income and $40K of net capital gains would pay the extra 3.8% tax on $20K of their net gains; a single filer with $210K of earned income and $30K of net capital gains would pay the extra 3.8% tax on all of their net gains. (We're assuming there are no above the line deductions in these cases, so their MAGI equals their gross income.) This tax means that some people pay an 18.8% marginal rate on long-term gains instead of 15%, and nearly all those in the 20% bracket actually pay 23.8%.
