...
Your [filing status](https://en.wikipedia.org/wiki/Filing_status) is an important part of your tax return, and it's partly determined by your marital status on December 31. Most people who are not married are single filers, and most who are married are joint filers. Married people can also file separately, but it generally leads to paying more tax, so the default for married people should be to file jointly. Married filing separately is not the same as the single filing status. Married people cannot choose to be single filers, [even if it lowers](https://github.com/investindex/Taxes#f3) their tax burden. There are additional, less common filing statuses.
...
If I say something about "my 2022 taxes", am I referring to taxes I paid on income earned in 2022, or the tax return I filed in 2022 based on income earned in 2021? The term "tax year" can help avoid ambiguity. Most Americans filed their tax returns for the 2022 tax year in early 2023. They will file returns for the 2023 tax year in early 2024.

Credits and deductions can reduce your taxes, and it's important to know the distinction. A tax credit is a simple reduction of your tax liability. If your federal income tax liability for a given year is $1,200, and you receive a $500 credit, your tax liability is reduced by $500. In contrast, a deduction reduces the amount of income that is subject to tax. For example, the [standard deduction](https://www.nerdwallet.com/article/taxes/standard-deduction) in the 2023 tax year for single filers under 65 is $13,850. Taking the standard deduction doesn't reduce your federal tax liability by $13,850. It means that your taxable income is reduced by $13,850, so that amount is not subject to any federal income tax.
...
We'll begin with calculating how much of your income is subject to income tax. Let's say we're a 30-year-old single filer who earned $69,650 from our job in 2023. We also realized $5,000 in capital gains, and adding these two values gives us our [gross income](https://www.investopedia.com/terms/g/grossincome.asp) of $74,650. We paid $800 in student loan interest in 2023, so we can deduct that from our gross income of $74,650 to give us our [adjusted gross income (AGI)](https://www.nerdwallet.com/article/taxes/adjusted-gross-income-agi) of $73,850. AGI is always less than or equal to gross income, because it's calculated by taking certain deductions. Deductions used to calculate AGI are called above the line deductions.<sup id="fn1">[[1]](#f1)</sup> After finding their AGI, most people take the standard deduction, because it's preferable to itemizing deductions unless you donate a great deal to charity or pay a lot of tax-deductible interest (among other reasons).<sup id="fn2">[[2]](#f2)</sup> The federal [standard deduction](https://www.nerdwallet.com/article/taxes/standard-deduction) for income tax in 2023 is $13,850 for single filers and twice that ($27,700) for married people filing jointly. It's slightly expanded for those who are at least 65. So we subtract $13,850 from our AGI, leaving us with a taxable income of $60,000. This is the amount that will be subject to federal income tax.
...
Let's say in our example above with $5,000 of capital gains, we realized a net $2,000 in short-term capital gains and a net $3,000 in long-term capital gains in 2023. How much federal income tax will we pay? You can imagine these amounts stacked on each other, with the earned income on the bottom, the net short-term capital gain in the middle, and the net long-term capital gain on top. You want the long-term gain on top because its marginal rate is lower than that of ordinary income for nearly every taxpayer.<sup id="fn4">[[4]](#f4)</sup> Because short-term capital gains are taxed as ordinary income, we can merge the earned income and short-term gain into $57,000 of ordinary income. If you like, below everything you can imagine the standard deduction of $13,850, which is taxed at 0%.

[We pay](https://www.nerdwallet.com/article/taxes/federal-income-tax-brackets) 10% on the first $11,000 of taxable income ([$1,100](https://www.wolframalpha.com/input?i=.1*11000)), then 12% up to $44,725 ([$4,047](https://www.wolframalpha.com/input?i=.12*%2844725-11000%29)), then 22% up to $57,000 ([$2,700.50](https://www.wolframalpha.com/input?i=.22*%2857000-44725%29)), for a total of $7,847.50. Tax forms round values to the nearest dollar, so some rounding would occur. Our net long-term capital gain of $3K is on top of the imaginary stack of $57K of ordinary income, so it ranges from $57K to $60K. That entire range is higher than $44,625 but less than $492,300, so [we pay](https://www.nerdwallet.com/article/taxes/capital-gains-tax-rates) 15% on all of our long-term gains ([$450](https://www.wolframalpha.com/input?i=.15*3000)), for a total of $8,297.50 of income tax owed. The net investment income tax does not apply because our [MAGI](https://www.investopedia.com/terms/m/magi.asp) of $74,650 is far too low. See above for calculation of our AGI. A common difference between AGI and MAGI is that student loan interest can [sometimes](https://www.thebalance.com/student-loan-interest-deduction-3193022) be deducted from AGI, but is added back to calculate MAGI.
...
FICA taxes — short for Federal Insurance Contributions Act taxes — are federal payroll taxes. 6.2% of your paycheck funds Social Security, and an additional 1.45% funds Medicare. These add to 7.65% of all your earned income (unless your income is high). The Social Security tax stops after $160,200 of individual earnings in 2023. But the Medicare tax has no income cap and actually escalates by 0.9% for income above $200K for single filers and $250K for joint filers. __The deductions for income tax do not apply to FICA taxes: these taxes start at the first dollar earned.__ Continuing our example from above: so we need to pay 7.65% on the full earned income of $69,650. This works out to [$5,328](https://www.wolframalpha.com/input?i=.0765*69650) in FICA taxes, which were likely withheld from our paycheck throughout the year. FICA taxes do not apply to capital gains or distributions, so we don't pay any more federal tax on our capital gains (including the short-term gain).

That's a total of about $13,626 in federal tax liability. Let's say $13,300 in federal tax was withheld throughout 2023 by our employer, so we owe $326 to the IRS on tax day. Some people would be upset that they didn't receive a refund, but we understand that a refund means providing the IRS with an interest-free loan until it returns our own money to us. If we had really wanted to avoid paying on tax day, we could've paid more tax throughout the year by withholding more through our employer (or sending money directly to the IRS). The section below on [estimated payments](https://github.com/investindex/Taxes#estimated-tax-payments) explains under what conditions you can wait to pay your full tax liability, and how to avoid waiting in a way that would trigger interest or penalty charges.

The main way we could have reduced FICA taxes would have been to contribute to a [health savings account (HSA)](https://github.com/investindex/TaxAdv#health-savings-accounts) through our employer's payroll deduction. We could have contributed as much as $3,850 in 2023 and reduced our earned income that was subject to FICA taxes by that amount (or by up to $7,750 for a family insurance plan). An additional $1,000 is allowed for those who are at least 55 years old. Assuming a single plan and age less than 55, maxing out these contributions would have reduced our federal income tax and FICA taxes by [$1,142](https://www.wolframalpha.com/input?i=3850%28.22%2B.0765%29). Contributing $6,500 to a traditional IRA would have reduced our federal income tax by a further [$1,430](https://www.wolframalpha.com/input?i=6500*.22) (with no effect on FICA taxes). These contributions would reduce our AGI by a total of $[10,350](https://www.wolframalpha.com/input?i=6500%2B3850), from $73,850 to $63,500. Our MAGI of $70,800 would be computed by adding back deductions from the $6,500 IRA contribution and the $800 of student loan interest, but not the HSA contribution. 401(k) contributions could have reduced income tax further, and we would want to prioritize these above IRA contributions if our employer had a matching policy. Unlike traditional IRA contributions, traditional 401(k) contributions are _not_ added back to calculate MAGI. If we wanted to reduce our MAGI — for which potential reasons are discussed [below](https://github.com/investindex/Taxes#tax-advantaged-accounts) — this could make traditional 401(k) contributions preferable. Depending on the state we work in, these actions could save even more money by reducing state taxes.
...
The government doesn't make it terribly easy to receive appropriate tax deductions for charitable donations. Those taking the standard deduction in 2023 get zero points with Uncle Sam for charitable donations. A single filer who donated $5,000 might still take the standard deduction because their itemized deductions were less than $13,850. This generous donor would receive the same deduction as a similar person who donated nothing.
...
Despite some [great](https://www.youtube.com/watch?v=Z-p4blkmU54) [explanations](https://smartasset.com/retirement/gift-tax-limits) online, there is pervasive confusion about taxes on monetary gifts. The IRS does not care about people gifting one another normal amounts of money, and very few people ever need to pay gift tax. In 2023, you can gift any number of people up to $17K each without tax reporting obligations. Once you exceed the $17K exemption for any gift receiver in a given year, usually you still have no tax liability. But you do have a reporting obligation. When the gift-giver files their taxes, they should report the excess over $17K that they've gifted to each person in that tax year. So if I gifted one person $12K and another person $20K in 2023, I would report the $3K taxable gift on Form 709, but I would probably not owe any tax. The excess over the annual exemption counts toward your lifetime gift tax exemption. The lifetime exemption is $12.92 million in 2023. Like the annual exemption of $17K, it's indexed to inflation and can change each year.

If you were to cumulatively gift more than $12.92 million beyond the $17K per-person exemption you're given each year, only then would you exhaust your lifetime exemption and pay gift tax. Reimbursements don't count as gifts, so sending someone money doesn't always count toward the annual exemption. Directly paying someone's medical bills or a student's tuition is also not counted as a gift for tax purposes. Property with monetary value, like a car or house, does count as a gift. Gifts given to a spouse (who is a US citizen) or to a dependent are not counted. If you're married, the limit is unchanged at $17K per person. You and your spouse could each give $17K to the same person in the same year without reporting obligations. The joint lifetime exemption is naturally doubled to nearly $26 million. A vast majority of people will never be wealthy enough to potentially owe federal gift tax. The only states with gift taxes are Connecticut and Minnesota. There are a number of states with inheritance or estate taxes.

When I said the IRS does not care about gifting normal amounts, I meant it: even those who admit to failing to report gifts are generally [not fined at all](https://www.youtube.com/watch?v=f5DfqXcbS0M) because no tax avoidance occurred. There is good reason to believe that enormous amounts of noncompliant gifting flow between US citizens every year, which the IRS does not address because it would require expensive and intrusive gathering of information in exchange for very little tax revenue.
...
As mentioned previously, traditional IRA contributions are tax-deductible. However, if you're covered by a retirement plan at work — usually a 401(k) or 403(b) — _and_ your income is high enough, this is [not true](https://www.irs.gov/retirement-plans/2023-ira-deduction-limits-effect-of-modified-agi-on-deduction-if-you-are-covered-by-a-retirement-plan-at-work). Everyone can contribute to a traditional IRA, but if your [MAGI](https://www.investopedia.com/terms/m/magi.asp) is at least $83K for single filers or at least $136K for joint filers, it will not reduce your taxable income. Single filers making $73K-$83K and joint filers making $116K-$136K can take only a partial deduction, based on a linear sliding scale. For example, a 40-year-old single filer with a 401(k) option at work is eligible to contribute up to $6,500 to their traditional IRA, but if their MAGI were $78K (halfway between $73K and $83K), they could deduct at most only half that amount ($3,250) from their taxable income by contributing at least $3,250. Any contributions beyond $3,250 would not reduce taxes in the 2023 tax year. As mentioned previously, those who are at least 50 start with a higher maximum of $7,500.

These limitations mean that if your MAGI exceeds $73K (for single filers) or $116K (for joint filers), you’re better off ignoring your traditional IRA and investing through your employer-sponsored retirement plan (or your HSA!). If your employer doesn’t offer a retirement plan, then these income caps don’t apply to you, unless you’re married and your spouse _is_ covered by a work plan. If only one spouse is covered by a work retirement plan, then [deductions](https://www.irs.gov/publications/p590a) for traditional IRA contributions phase out between $218K and $228K.
...
Not everyone can contribute directly to a Roth IRA: if your MAGI is at least $153K for single filers or $228K for joint filers in 2023, you [cannot contribute](https://www.irs.gov/retirement-plans/amount-of-roth-ira-contributions-that-you-can-make-for-2023) to a Roth IRA. Reductions in the maximum contribution proceed on a linear sliding scale from $138K-$153K for single filers and $218K-$228K for joint filers. For example, a pair of 40-year-old joint filers with a MAGI of $223K could contribute a maximum of $3,425 to each of their Roth IRA. This income cap is nearly toothless, however, because anyone can still contribute the maximum to a Roth IRA [through a backdoor](https://www.whitecoatinvestor.com/backdoor-roth-ira-tutorial/). You first contribute to a traditional IRA and immediately convert it to a Roth IRA. When tax day arrives, you owe income tax on the contributions, as any Roth IRA contributor would. However, you can't withdraw converted funds penalty-free for [five years](https://github.com/investindex/TaxAdv#five-year-rules-for-your-roth-ira), unlike direct contributions.

These income restrictions imply that for people with employer-sponsored retirement plans and high enough MAGI — single filers > $83K and joint filers > $136K — a Roth IRA or backdoor Roth IRA contribution is always superior to a traditional IRA contribution. However, this doesn't mean they _should_ use a Roth IRA, because many such people would benefit more from additional contributions to their traditional 401(k) or HSA, thereby reducing taxes in the current year.

Even if gross income exceeds these thresholds, MAGI might not. If we're a 40-year-old single filer with a gross income of $160K, at first glance you might think we can't contribute directly to a Roth IRA. But if we max out our traditional 401(k) with $22,500 and our HSA with $3,850, we've reduced our MAGI by $26,350 and it now falls below $138K! No need for a backdoor.
...
As you might expect, 401(k) contributions can apply only to the current year: contributions for tax year 2023 cannot be made after Dec 31 2023, and they need to be made through payroll deduction. HSA contributions do not _need_ to be made through payroll deduction but it would be foolish not to do so, because contributing the money yourself would cause you to owe FICA taxes on that income. The only exception is if your employer does not offer pre-tax deposits to an HSA, but your health plan is eligible and you've decided to contribute on your own. 
...
The retirement savings contributions credit — commonly called the saver's credit — is a major incentive for people with low income to contribute to retirement accounts. Depending on your AGI, [between 10% and 50%](https://www.irs.gov/retirement-plans/plan-participant-employee/retirement-savings-contributions-savers-credit) of your contribution can be provided as a tax credit, with a cap of $1,000 for single filers and $2,000 for joint filers. A single filer with an AGI of $21,000 in 2023 could contribute $1,000 to a Roth IRA and receive $500 at tax time. Contributions to a 401(k) could potentially be rewarded with employer matching as well. Unfortunately, students enrolled full-time during any part of five calendar months of the tax year are ineligible. So it doesn't help most people in their year of college graduation, when they might have unusually low income compared to later years.

Recall the distinction between refundable and nonrefundable tax credits, as introduced in [the basics](https://github.com/investindex/Taxes#the-basics). The saver's credit is nonrefundable, which means that it can lower your ordinary income tax liability to zero, but cannot reduce it further. The single filer with an AGI of $21,000 — assuming the whole amount is earned income — would owe [$715](https://www.wolframalpha.com/input?i=.1*%2821000-13850%29) in federal income tax. So the saver's credit would be 50% of their IRA contribution for any contribution up to $1,430, but the credit could not exceed $715 (and regardless of circumstances, the credit cannot exceed $1,000). Even though they paid [$1,607](https://www.wolframalpha.com/input?i=21000*.0765) in FICA taxes, income tax credits have no effect on this liability.
...
Marginal tax rates are not static. Let's say someone is a single filer in 2023 with $47,725 of ordinary taxable income. The threshold for the federal tax rate of 22% is $44,725, so $3,000 of their income is taxed at 22%. They could contribute $3,000 to a traditional IRA, which would reduce their taxable income and drop their marginal tax rate to 12%. Now none of their income is taxed at 22%. If their marginal federal tax rate in retirement might be more than 12%, it could make sense to contribute the remaining $3,500 to a Roth IRA.
...
However, we don't want this to change our portfolio. We also don't want to trigger a wash sale by immediately repurchasing VTI. So as soon as we sell VTI at a loss, we buy an equivalent amount of [SCHB](https://www.schwabassetmanagement.com/products/schb), another total US stock ETF. We know they will have highly similar returns because, according to [this tool](https://www.etfrc.com/funds/overlap.php), the weighted allocations of VTI and SCHB have an overlap of 97%. Yet the IRS does not consider them “substantially identical” securities, because they track different indices. Unfortunately, the IRS has never provided clear guidance on precisely what criteria would make two funds substantially identical or not. It may even be perfectly fine to switch from one S&P 500 ETF to another, but I would avoid switching between funds that track the same index. Any similarity beyond that is not a concern.
...
* Understand [the basics](https://github.com/investindex/Taxes#the-basics): marginal vs. effective tax rate; return vs. refund; filing status; dependent; tax year; credit vs. deduction; refundable vs. non-refundable credit.

* Understand [the essentials](https://github.com/investindex/Taxes#the-essentials): gross income, AGI, and MAGI; standard deduction vs. itemized deductions; long-term vs. short-term gains and losses; FICA taxes; FIFO disposal method; qualified dividend; gift tax exemption.

* Understand the [income restrictions](https://github.com/investindex/Taxes#tax-advantaged-accounts) (based on MAGI) that apply to traditional and Roth IRAs, and the appropriate timing for contributions to tax-advantaged accounts. The saver's credit is a major tax credit for low-income people who contribute to retirement accounts.

* The properly balanced use of [Roth and traditional](https://github.com/investindex/Taxes#roth-or-traditional) retirement accounts will attempt to distribute payment of income tax from your earning years to your non-earning years, but not by so much that you pay higher tax rates during non-earning years. There are a number of factors to consider each year when deciding whether to contribute 100% to Roth accounts, 100% to traditional accounts, or some combination.
...
<sup id="f1"> 1 </sup> Student loan interest can reduce your taxable income in addition to the standard deduction because it can be used for an [above the line](https://www.thebalance.com/above-the-line-deductions-to-reduce-your-tax-bill-4584471) deduction. It reduces your [adjusted gross income](https://www.nerdwallet.com/article/taxes/adjusted-gross-income-agi), which is calculated _before_ you take the standard deduction. The [student loan interest deduction](https://www.thebalance.com/student-loan-interest-deduction-3193022) is limited to $2,500 per year, and your income must be low enough. Contributions to your HSA, 401(k), and IRA can also be above the line, with income caveats for [the IRA](https://github.com/investindex/Taxes#traditional-iras) but [not HSA or 401(k)](https://github.com/investindex/Taxes#tax-advantaged-accounts). [↩](#fn1)

&nbsp;

<sup id="f2"> 2 </sup> Let's say a married couple who owns an expensive home is considering whether to itemize deductions or take the standard deduction of $27,700. They paid a lot in state and local income and property tax, so they can [deduct](https://www.thebalancemoney.com/property-tax-deduction-3192847) the maximum of $10,000 from their federal taxable income (see the SALT deduction). They recently bought their home and pay a great deal of mortgage interest. Let's say they paid $25,000 of [deductible mortgage interest](https://www.investopedia.com/terms/home-mortgage-interest.asp). And let's say they donated $2,000 to charity. They choose to itemize because they can deduct $37,000 instead of $27,700. Medical expenses above a high threshold determined by your AGI can also be used as an itemized deduction. The medical expenses that can count are [broader than you might think](https://www.wsj.com/articles/medical-deduction-taxes-84a7d9d5). Deductible medical expenses don't even have to be for yourself; paying for the expenses of others can also be deductible. [↩](#fn2)

&nbsp;

<sup id="f3"> 3 </sup> This is a lesser-known fact of federal US taxes: it is assumed that being married provides a tax advantage, but for some very high earners being married is actually detrimental. Tax brackets for ordinary income are linked [here](https://www.nerdwallet.com/article/taxes/federal-income-tax-brackets) for reference. Let's start with an above-average but fairly typical case of a couple with total AGI of $100K. Spouse A makes $40K and Spouse B makes $60K. If they were single filers, they would pay [$2,918](https://www.wolframalpha.com/input?i=1100+%2B+.12*%2840000-13850-11000%29) and [$5,461](https://www.wolframalpha.com/input?i=5147+%2B+.22*%2860000-13850-44725%29) for a total of $8,379. But as joint filers, they pay [$8,236](https://www.wolframalpha.com/input?i=2200+%2B+.12*%28100000-27700-22000%29). In the lower brackets, the thresholds for joint filers are precisely twice as much as those for single filers, which advantages any imbalance between the incomes of Spouse A and Spouse B. As a single filer, Spouse B would pay a marginal rate of 22% but, as a couple, Spouses A and B pay a marginal rate of 12%. If their AGIs were both exactly $50K, the effect of marriage on federal income tax would be perfectly neutral. For typical taxpayers, marriage helps.

This pattern does not always hold if income is very high. Imagine a couple whose incomes add to $800K. If both spouses make $400K, they would each owe [$107,047](https://www.wolframalpha.com/input?i=52832+%2B+.35*%28400000-13850-231250%29) as single filers, for a total of $214,094. But as joint filers, they actually owe [$215,665](https://www.wolframalpha.com/input?i=186601.5+%2B+.37*%28800000-27700-693750%29). The slight marriage penalty occurs because the 37% threshold for joint filers ($693,750) is much less than twice the threshold for single filers ($578,125). As single filers, these high earners wouldn't enter the 37% federal bracket, but they do as joint filers.

However, we can imagine an imbalanced pair in which Spouse A makes $100K and Spouse B makes $700K. As single filers, they would pay [$14,261](https://www.wolframalpha.com/input?i=5147+%2B+.22*%28100000-13850-44725%29) and [$214,208](https://www.wolframalpha.com/input?i=174238.25+%2B+.37*%28700000-13850-578125%29) for a total of $228,469. But as joint filers, they pay only [$215,665](https://www.wolframalpha.com/input?i=186601.5+%2B+.37*%28800000-27700-693750%29). So for federal income tax with the standard deduction, there is a marriage penalty to high earners with fairly balanced incomes, but the marriage discount holds for high-earning couples with very imbalanced incomes.

Any marriage penalty shown here for federal income tax has been relatively small. But the marriage penalties for high earners are more glaring in thresholds for [long-term capital gains](https://www.nerdwallet.com/article/taxes/capital-gains-tax-rates) ($492,300 vs. $553,850 for the 20% threshold), the net investment income tax ($200K vs. $250K), the additional Medicare tax ($200K vs. $250K), the phasing out of deductions for traditional IRA contributions ($83K vs. $136K), and the phasing out of eligibility for direct Roth IRA contributions ($153K vs. $228K). All of these thresholds are mentioned above. In addition, interest on [US Treasury savings bonds](https://github.com/investindex/Risk#us-treasury-savings-bonds) is tax-deductible if used for education, but the deduction is [phased out](https://www.treasurydirect.gov/indiv/planning/plan_education.htm) at higher MAGI ($100,800 vs. $158,650 in the 2022 tax year).
