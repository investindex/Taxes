...
As you might assume, you'll be taxed according to your _net_ gains. Ideally you could minimize short-term gains, because of their higher tax rate. But long-term losses must be used to offset long-term gains first, and only if long-term losses exceed long-term gains can the remaining long-term losses be used to reduce short-term gains. Your gains and losses counterbalance within each category, and only if you realized a net gain in one category and a net loss in the other do they offset one another. The possibilities at the end are (1) a net ST gain and net LT gain, (2) a net ST gain, (3) a net LT gain, (4) a net ST loss and LT loss, (5) a net ST loss, and (6) a net LT loss. If you had, for instance, a net LT gain and a net ST loss, the larger would cancel the smaller.

If you suffer a net loss, it reduces your taxable income. This deduction has a limit of $3,000 (unless you establish trader tax status, which is for very frequent traders). However, any net losses that exceed the limit can be deferred to future years.
