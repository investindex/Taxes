...
Tax awareness is important not only because of your legal obligation to file taxes correctly, but also because planning ahead can increase your returns by reducing the taxes you pay. Even if you pay someone to do your taxes, you need to understand the principles here. This section applies only to trades in taxable accounts. It will describe taxes as they concern stock trading, and when needed it will expand with the additional knowledge required to trade stock funds and bond funds.
