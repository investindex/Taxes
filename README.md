...
Let's also ensure we understand the distinction between income and taxable income. The federal [standard deduction](https://www.nerdwallet.com/article/taxes/standard-deduction) for income tax in 2022 is $12,950 for single filers and twice that ($25,900) for married people filing jointly. Let's say we're a single filer who earns $63,250 in 2022 from our job. We'll donate at least $300 to charity in 2022, so [we can deduct](https://www.irs.gov/about-irs/the-irs-encourages-taxpayers-to-consider-charitable-contributions) $300 from our taxable income, even though we're taking the standard deduction.<sup id="fn1">[1](#f1)</sup> Subtracting $300 from our gross income of $63,250 gives us an [adjusted gross income (AGI)](https://www.nerdwallet.com/article/taxes/adjusted-gross-income-agi) of $62,950. Unless we donate a great deal to charity or pay a lot of tax-deductible interest, for example, taking the standard deduction is preferable to itemizing deductions. Most people take the standard deduction. So we subtract $12,950 from our AGI, leaving us with a taxable income of $50,000. This amount is what will be subject to income tax.
...
FICA taxes, also known as payroll taxes, are an important federal tax in addition to income tax. 6.2% of your paycheck funds Social Security, and an additional 1.45% funds Medicare. These add to 7.65% of all your earned income. The Social Security tax stops after $147,000 of individual earnings in 2022, so high earners pay less than 6.2% to Social Security. But the Medicare tax has no income cap and actually escalates by 0.9% at a higher income ($200K for single filers, $250K for joint filers). Continuing our example from above: the deductions for income tax do not apply to FICA tax, so we need to pay 7.65% on the full earned income of $63,250 (instead of $50,000). This works out to $4,838.62 in FICA taxes, which were likely withheld from our paycheck throughout the year. FICA taxes do not apply to capital gains or distributions, so we don't pay any more federal tax on our capital gains (including the short-term gain). That's a total of $12,345 in federal taxes.
