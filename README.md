...
Let's say that for five years they set aside $5K per year before income taxes, for a total of $25K. The $25K could have been contributed after taxes to a Roth account, so the contribution would have been $25K × .86 = $21.5K. Or the $25K could have been contributed in full to a traditional account. Let's say that in the next 40 years, these contributions multiply by 18 in nominal terms (i.e., not adjusted for inflation). So the Roth amount of $21.5K would grow to $387K and the traditional amount of $25K would grow to $450K. When the money is finally withdrawn from a Roth IRA over a number of years, there is no tax owed, so it is still $387K after tax. When the money is withdrawn from a traditional IRA each year and subject to 30% tax, the after-tax value of the withdrawal is smaller even though the pre-tax amount was larger: $450K × .7 = $315K. By contributing some money to Roth accounts, this person would have been able to reduce their marginal (and effective) tax rates in retirement. They surrendered wealth by backloading taxes and paying too much tax in retirement.
