...
As you might assume, you'll be taxed according to your _net_ gains. Ideally you could minimize short-term gains, because of their higher tax rate. But long-term losses must be used to offset long-term gains first, and only if long-term losses exceed long-term gains can the remaining long-term losses be used to reduce short-term gains. Your gains and losses balance out within each category, and only if you realized a net gain in one category and a net loss in the other do they offset one another.

Any final net loss once the two categories have settled up is the same: it reduces your taxable income. So the possibilities at the end are (1) a net ST gain and net LT gain, (2) a net ST gain, (3) a net LT gain, and (4) a net loss. Deduction from your taxable income in a given year has a limit of $3,000 (unless you establish trader tax status, which is for very frequent traders). Any net losses that exceed the limit can be deferred to future years. But if losses are carried over, then the distinction between ST and LT net losses begins to [matter](https://www.irs.gov/publications/p544). For instance, if you realized a $5,000 net loss in Year 1 composed entirely of LT losses, you would deduct $3,000 from your income in Year 1. In Year 2, you would have the opportunity to offset $2,000 of capital gains, but the LT losses must preferentially cancel LT gains. So net ST and net LT losses (or a combination) are meaningfully different outcomes if total losses exceed $3,000.
