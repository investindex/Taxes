...
Let's also ensure we understand the distinction between income and taxable income. The federal [standard deduction](https://www.nerdwallet.com/article/taxes/standard-deduction) for income tax in 2022 is $12,950 for single filers and twice that ($25,900) for married people filing jointly. Let's say we're a single filer who earns $63,250 in 2022 from our job. We can subtract the standard deduction from our income, leaving us with $50,300 of taxable income. We'll donate at least $300 to charity in 2022, so [we can deduct](https://www.irs.gov/about-irs/the-irs-encourages-taxpayers-to-consider-charitable-contributions) $300 from our taxable income, which is now only $50,000. Unless we donate a great deal to charity or pay a lot of tax-deductible interest, for example, taking the standard deduction is preferable to itemizing deductions. Most people take the standard deduction. The taxable income we'll refer to below is the lower amount of $50,000 rather than the income we earned.
